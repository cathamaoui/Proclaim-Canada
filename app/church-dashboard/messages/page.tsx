            ...
            <div className="overflow-y-auto flex-1">
              {conversations.map((conv) => (
                ...
                >
                  ...
                  <p className="text-gray-500 text-xs truncate">{conv.partner?.role === 'PREACHER' ? 'Preacher' : 'Church'}</p>
                  {conv.lastMessage && (
                    <>
          ...
          {selectedConv ? (
            <>
              ...
              <div className="p-4 border-b border-gray-200">
                ...
                <p className="text-xs text-gray-500">{selectedConv.partner?.role === 'PREACHER' ? 'Preacher' : 'Church'}</p>
              </div>
