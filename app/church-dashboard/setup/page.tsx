...
const CITIES_US = {
  ...
  'Florida': ['Miami', 'Orlando', 'Tampa', 'Jacksonville', 'St. Petersburg', 'Tallahassee', 'Fort Lauderdale', 'Hialeah', 'Lakeland', 'Boca Raton', 'Doral', 'Boynton Beach', 'Coral Springs', 'Pembroke Pines', 'Cape Coral', 'Fort Myers', 'Clearwater', 'Daytona Beach', 'West Palm Beach', 'Port St. Lucie', 'Naples', 'Ocala', 'Pensacola', 'Destin', 'Panama City', 'Kissimmee', 'Apopka'],
  'Georgia': ['Atlanta', 'Augusta', 'Savannah', 'Athens', 'Columbus', 'Macon', 'Dalton', 'Marietta', 'Sandy Springs', 'Roswell', 'Johns Creek', 'Alpharetta', 'Rome', 'Canton', 'Cartersville', 'Kennesaw', 'Decatur', 'Gainesville', 'Valdosta', 'Waycross', 'Albany', 'Thomasville'],
  ...
  'Kansas': ['Kansas City', 'Wichita', 'Topeka', 'Overland Park', 'Olathe', 'Lawrence', 'Salina', 'Manhattan', 'Hutchinson', 'Garden City', 'Great Bend', 'Hays', 'Leawood', 'Shawnee'],
  ...
  'Louisiana': ['New Orleans', 'Baton Rouge', 'Shreveport', 'Lafayette', 'Lake Charles', 'Monroe', 'Houma', 'Alexandria', 'Gretna', 'Marrero', 'Slidell', 'Kenner', 'Metairie', 'Morgan City', 'DeRidder', 'Thibodaux'],
  ...
  'Minnesota': ['Minneapolis', 'St. Paul', 'Duluth', 'Rochester', 'Bloomington', 'Minnetonka', 'Edina', 'Plymouth', 'Eagan', 'Burnsville', 'Coon Rapids', 'Mankato', 'Moorhead', 'Fargo', 'St. Cloud', 'Winona', 'Albert Lea'],
  ...
  'Pennsylvania': ['Philadelphia', 'Pittsburgh', 'Allentown', 'Erie', 'Reading', 'Scranton', 'Bethlehem', 'Lancaster', 'Harrisburg', 'Altoona', 'Johnstown', 'Chester', 'Wilkes-Barre', 'Hazleton', 'Bloomsburg', 'Towanda', 'Sunbury'],
  ...
  'Texas': ['Houston', 'Dallas', 'Austin', 'San Antonio', 'Fort Worth', 'El Paso', 'Arlington', 'Corpus Christi', 'Plano', 'Garland', 'Lubbock', 'Irving', 'Beaumont', 'Port Aransas', 'Amarillo', 'Abilene', 'Midland', 'Odessa', 'Waco', 'Tyler', 'Longview', 'Sherman', 'Paris', 'Texarkana'],
  ...
  'Virginia': ['Richmond', 'Virginia Beach', 'Arlington', 'Alexandria', 'Roanoke', 'Hampton', 'Newport News', 'Charlottesville', 'Blacksburg', 'Wytheville', 'Lewisburg', 'Abingdon', 'Marion', 'Christiansburg', 'Danville', 'Lynchburg'],
...
const CITIES_CANADA = {
  ...
  'Manitoba': ['Winnipeg', 'Brandon', 'Winkler', 'Steinbach', 'Selkirk', 'Dauphin', 'Thompson', 'Flin Flon', 'Portage la Prairie', 'Swan River', 'Virden', 'Morden'],
