...
const PRICING_PLANS = [
  ...
  {
    category: 'Multi-Job Packs',
    plans: [
      {
        id: 'pack-3-jobs',
        jobCount: '3 Job Postings',
        days: '30-90 day credits',
        price: '$249',
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        {PRICING_PLANS.map((section, sectionIdx) => (
          <div key={sectionIdx} className="mb-20">
            ...
            <div className={`grid grid-cols-1 ${section.category === 'Single Job Posting' ? 'md:grid-cols-3 lg:grid-cols-6' : 'md:grid-cols-3'} gap-6 auto-rows-fr`}>
